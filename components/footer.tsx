    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="flex flex-wrap justify-between items-center">
          <div className="w-full md:w-1/3 text-center md:text-left mb-6 md:mb-0">
            ...
            <p className="text-sm text-gray-400">
              Creating visually stunning experiences with cutting-edge animations.
            </p>
          </div>
          <div className="w-full md:w-1/3 text-center mb-6 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services" className="hover:text-purple-400 transition duration-300">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/portfolio" className="hover:text-purple-400 transition duration-300">
                  Portfolio
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 text-center text-sm text-gray-400">
          <p>&copy; 2023 Stunning. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
